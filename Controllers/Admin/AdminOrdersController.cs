...
namespace BookLibrary.Controllers.Admin
{
    public class AdminOrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,DateOrder,Total,Discount,UserId,Address")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,DateOrder,Total,Discount,UserId,Address")] Order order)
        {
            if (ModelState.IsValid)
            {
